                ...
                child: isSubmitting
                    ? const Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 12),
                          Text('Memperbarui...', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w600)),
                        ],
                      )
                    : const Text('Perbarui Ulasan', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w600)),
              ),
            ),
          ],
        ),
