...
class _PlaceDetailPageState extends ConsumerState<PlaceDetailPage> {
  ...
  void _updateCurrentPlace() async {
    // Get the latest version of this place using the correct provider
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 6),
                                    Text(
                                      "Rp.${_currentPlace.weekdayPrice ?? _currentPlace.price ?? 0}",
                                      style: const TextStyle(
                                        fontSize: 12,
                                        fontWeight: FontWeight.bold,
                                        color: Colors.blue,
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 6),
                                    Text(
                                      "Rp.${_currentPlace.weekendPrice ?? ((_currentPlace.price ?? 0) + 15000)}",
                                      style: const TextStyle(
                                        fontSize: 12,
                                        fontWeight: FontWeight.bold,
                                        color: Colors.blue,
